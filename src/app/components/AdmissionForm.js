...
//     payment_utr: "",          // UTR/Transaction ID
//     payment_date: "",         // Payment date
//     payment_screenshot: "",

//     // Step 6: Reference Details
//     reference_name: "",       // Reference person name
//     reference_mobile: "",     // Reference mobile number
//     reference_relation: "",   // Relation with reference

//     // Step 7: Documents (will store file paths after upload)
//     documents: {
//       aadhar: "",
//       pan: "",
//       residence_proof: "",
...
//   // Add this useEffect for hotkeys - MOVE THIS BELOW resetForm function
// useEffect(() => {
//   const handleKeyPress = (e) => {
//     // Ctrl/Cmd + 1-7 to jump to steps (now 7 steps total)
//     if ((e.ctrlKey || e.metaKey) && e.key >= '1' && e.key <= '7') {
//       const stepNumber = parseInt(e.key);
//       setStep(stepNumber);
//       toast.success(`Jumped to step ${stepNumber} (Dev Shortcut)`);
//     }

//     // Ctrl/Cmd + R to reset form
//     if ((e.ctrlKey || e.metaKey) && e.key === 'r') {
//       resetForm();
//       toast.success('Form reset (Dev Shortcut)');
//     }

//     // Ctrl/Cmd + ArrowRight to go to next step
//     if ((e.ctrlKey || e.metaKey) && e.key === 'ArrowRight') {
//       e.preventDefault();
//       if (step < 7) { // UPDATE FROM 5 to 7
//         setStep(step + 1);
//         toast.success(`Next → Step ${step + 1} (Dev Shortcut)`);
//       }
//     }

//     // Ctrl/Cmd + ArrowLeft to go to previous step
//     if ((e.ctrlKey || e.metaKey) && e.key === 'ArrowLeft') {
//       e.preventDefault();
//       if (step > 1) {
//         setStep(step - 1);
//         toast.success(`Back ← Step ${step - 1} (Dev Shortcut)`);
//       }
//     }
//   };
...
//         if (!formData.documents.payment_screenshot || formData.documents.payment_screenshot === '') {
//           toast.error("Please upload payment screenshot");
//           return false;
//         }

//         if (!formData.payment_utr || formData.payment_utr.trim() === '') {
...
//         // UTR validation (12-16 digits)
//         const utrRegex = /^[0-9]{12,16}$/;
//         if (!utrRegex.test(formData.payment_utr.replace(/\s/g, ''))) {
//           toast.error("Invalid UTR/Transaction ID (12-16 digits required)");
//           return false;
//         }
//         return true;
...
//       // ADD THIS NEW CASE 6:
//       case 6:
//         // Reference Details Validation
//         if (!formData.reference_name || formData.reference_name.trim() === '') {
//           toast.error("Please enter reference name");
//           return false;
//         }

//         if (!formData.reference_mobile || formData.reference_mobile.trim() === '') {
//           toast.error("Please enter reference mobile number");
//           return false;
//         }

//         // Validate reference mobile number
//         const refPhoneRegex = /^[6-9][0-9]{9}$/;
//         if (!refPhoneRegex.test(formData.reference_mobile)) {
//           toast.error("Invalid reference phone number");
//           return false;
//         }

//         if (!formData.reference_relation || formData.reference_relation.trim() === '') {
//           toast.error("Please enter relation with reference");
//           return false;
//         }
//         return true;

//       // UPDATE THIS FROM case 5 to case 7:
//       case 7:
...
//         payment_screenshot_uploaded: formData.documents.payment_screenshot || "",
//         reference_name: formData.reference_name,
//         reference_mobile: formData.reference_mobile,
//         reference_relation: formData.reference_relation,
...
//           Get Your Salary Advance Loan in 7 Easy Steps
//         </h2>
...
//             <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 transition-all duration-300 ${step === stepNumber
...
//             </div>
//             <span className={`text-xs font-medium text-center transition-all whitespace-nowrap ${step === stepNumber
...
//         {step === 4 && (
//           <div className="space-y-6">
//             <h3 className="text-xl font-semibold text-gray-900 mb-4">Account Verification Payment</h3>
//             <p className="text-sm text-gray-600 mb-6">Pay ₹100 account verification fee to proceed with your application</p>
...
//                     <li>Scan the QR code or use UPI ID to pay ₹100</li>
//                     <li>Take a screenshot of successful payment</li>
//                     <li>Upload the screenshot below</li>
//                     <li>Enter UTR/Transaction ID from SMS</li>
//                   </ol>
//                   <div className="bg-white p-4 rounded-lg border border-blue-300">
//                     <p className="text-sm font-medium text-gray-800 mb-1">UPI ID:</p>
//                     <p className="text-lg font-bold text-blue-600 mb-3">rupeylo@axisbank</p>
//                     <p className="text-sm text-gray-600">Amount: <span className="font-bold">₹100</span></p>
//                   </div>
//                 </div>
...
//                         <div className="w-32 h-32 bg-gray-300 mx-auto mb-2 flex items-center justify-center">
//                           <span className="text-gray-600">QR Code Placeholder</span>
//                         </div>
//                         <p className="text-xs text-gray-600">Scan to pay ₹100</p>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   Upload screenshot of successful payment showing ₹100 transaction
//                 </p>
//               </div>
...
//                   type="text"
//                   name="payment_utr"
//                   placeholder="Enter UTR from SMS"
//                   value={formData.payment_utr}
//                   onChange={handleChange}
//                   required
//                   maxLength="16"
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl placeholder-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
//                 />
//               </div>
...
//                   required
//                   max={new Date().toISOString().split('T')[0]}
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition  text-gray-700"
//                 />
//               </div>
//             </div>
//           </div>
...
//         {step === 5 && (
//           <div className="space-y-6">
//             <h3 className="text-xl font-semibold text-gray-900 mb-4">Reference Details</h3>
//             <p className="text-sm text-gray-600 mb-6">Please provide details of one reference person</p>
...
//                   type="text"
//                   name="reference_name"
//                   placeholder="Enter reference person's full name"
//                   value={formData.reference_name}
//                   onChange={handleChange}
//                   required
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-gray-600"
//                 />
//               </div>
...
//                   onChange={handleChange}
//                   required
//                   className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition text-gray-600"
//                 >
...
//   <div 
//     className={`overflow-hidden transition-all duration-300 ${isConsentExpanded ? 'max-h-96' : 'max-h-12'}`}
//     ref={consentTextRef}
//   >
//     I confirm that all information provided by me is true, complete, and accurate, and I understand that any misrepresentation may lead to rejection or cancellation of the loan as per applicable laws. I have read, understood, and voluntarily agree to the Payday Loan / Salary Advance Terms & Conditions, including interest, fees, GST, repayment schedule, and collection process. I expressly consent to pay Rs. 100 (Rupees One Hundred only), inclusive of applicable GST, towards credit bureau verification charges, which shall be non-refundable irrespective of loan approval or rejection. I authorize the lender, its NBFC/bank partners, service providers, and agents to verify my identity, employment, income, and credit history, access and share my information with credit bureaus, regulators, and legally permitted third parties, and contact me through calls, SMS, WhatsApp, email, or other digital modes for service, repayment reminders, and collection purposes in compliance with Indian laws and RBI guidelines. I agree to repay the loan on time through approved digital modes and acknowledge that delays or defaults may attract penal charges, legal recovery actions, and reporting to credit bureaus, which may impact my credit score. I further consent to electronic execution of agreements, e-mandates, and e-signatures, accept that the loan is subject to approval and disbursement at the lender's discretion, and agree that this acceptance shall be governed by the laws of India with exclusive jurisdiction of the competent courts.
//   </div>

//   <button 
//     type="button" 
//     onClick={() => setIsConsentExpanded(!isConsentExpanded)}
//     className="mt-1 text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1"
//   >
//     {isConsentExpanded ? (
//       <>
//         <span>See Less</span>
...
const AdmissionForm = () => {
  ...
  // Google Form URL
  const GOOGLE_FORM_URL = "https://forms.gle/nzJwffAQKnMPQ9iz9";
  ...
  const handleSubmit = (e) => {
    ...
    toast.success(
      <div className="text-center">
        <div className="font-bold text-green-600 mb-1">✅ Submission Successful!</div>
        <div className="text-sm">
          Your details have been received at Rupeylo. Our team will contact you shortly.
        </div>
      </div>,
      {
        duration: 5000,
    ...
    setTimeout(() => {
      ...
      setIsSubmitting(false);
      setIsConsentAgreed(false); // Reset checkbox
    }, 1500);
  };
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="text-center mb-8 pt-6 px-4">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">
          Get Your Salary Advance Loan in Simple Steps
        </h2>
        {/* <p className="text-gray-600">Complete the process below to get started</p> */}
      </div>
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="flex items-center">
            ...
            <div className="flex flex-col items-center mx-4">
              ...
              <span className="text-xs font-medium text-blue-600">Consent</span>
            </div>
            <div className="w-16 h-1 bg-gray-300 mx-2"></div>
            <div className="flex flex-col items-center mx-4">
              <div className="w-10 h-10 rounded-full bg-gray-300 text-white flex items-center justify-center mb-2">
                <span className="font-semibold">3</span>
              </div>
              <span className="text-xs font-medium text-gray-600">Application</span>
            </div>
          </div>
        </div>
      </div> */}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1">
                <h4 className="font-semibold text-blue-800 mb-3">Payment Instructions:</h4>
                <ol className="list-decimal list-inside text-sm text-blue-700 space-y-2 mb-4">
                  <li>Scan the QR code to pay ₹100 (including GST)</li>
                  <li>This is for credit bureau verification</li>
                  <li>Payment is mandatory to proceed with loan application</li>
                  <li>Complete payment before proceeding to next step</li>
                </ol>
  ...
  <p className="text-sm text-gray-600 mt-3 text-center">
    Scan the QR code to complete Bureau Verification payment and proceed with your loan application.
  </p>
  <p className="text-xs text-gray-500 mt-2 text-center">
    Note: This payment is mandatory and non-refundable.
  </p>
</div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border border-gray-300 rounded-xl p-6">
            ...
            <p className="text-xs text-gray-500 mt-3">
              * You must agree to these terms to proceed with the loan application
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border border-gray-300 rounded-xl p-6">
            <p className="text-sm text-gray-700 mb-4">
              After agreeing to the terms, click the button below to complete your loan application form.
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`px-8 py-4 rounded-lg font-semibold text-white text-lg transition-all ${!isConsentAgreed || isSubmitting
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              By clicking submit, you will be redirected to our secure Google Form to complete your application.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            Your information is secure and encrypted. We never share your details with third parties without your consent.
            Rupeylo is a responsible lender operating in compliance with RBI guidelines.
          </p>
        </div>
      </form>
    </div>
