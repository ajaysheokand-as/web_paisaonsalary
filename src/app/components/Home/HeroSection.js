...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden min-h-screen flex items-center">
     ...
     <div className="relative z-10 max-w-7xl mx-auto px-4  sm:px-6 lg:px-8 py-12 mt-12 lg:py-24 w-full">
  <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-16">
    {/* Left Content - Now sticky */}
    <div className="lg:w-1/2 text-center lg:text-left lg:sticky lg:top-24">
      {/* Badge */}
      ...
      {/* Subtitle */}
      <p className="text-lg md:text-xl text-gray-800 mb-8 leading-relaxed max-w-2xl">
